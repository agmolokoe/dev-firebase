  ...
  return (
    ...
    >
      <Card className="border-white/10 overflow-hidden bg-gradient-to-b from-black to-[#121212] shadow-glow-teal card-glow">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-teal-400/5 rounded-full blur-3xl -translate-x-1/4 -translate-y-1/4"></div>
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-blue-500/5 rounded-full blur-3xl -translate-x-1/3 translate-y-1/3"></div>
